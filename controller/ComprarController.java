...
import view.ComprarUsuarioFrame;
...
public class ComprarController {
    private ComprarUsuarioFrame view;
    private Usuario usuario;

    public ComprarController(ComprarUsuarioFrame view, Usuario usuario) {
        this.view = view;
    ...
    public void comprarCriptomoeda(){
        ...
        AtualizarController atualizacot = new AtualizarController(bitcoin, ripple, ethereum);
        String verificaSenha = view.getPwdComprar().getText();
        ...
        if(senha.equals(verificaSenha)){
           ...
           try{
                    ...
                    ResultSet res = dao.consultarTodasCripto();
    ...
    public void mostrarBitcoin(){
        ...
        try{
            ...
            if(res.next()){
                ...
                JOptionPane.showMessageDialog(view, "Bitcoin não comprado",
                        "Erro",JOptionPane.ERROR_MESSAGE);
            }
        } catch(SQLException e){
            JOptionPane.showMessageDialog(view, "Erro de conexao",
    ...
    public void comprarBitcoin(){
        ...
        try{
            ...
            if(res.next()){
                JOptionPane.showMessageDialog(view, "Bitcoin Comprado",
    ...
    public void comprarEthereum(){
        ...
        try{
            ...
            ResultSet res = dao.consultar(usuario);
            if(res.next()){
                JOptionPane.showMessageDialog(view, "Ethereum Comprado",
                        "Aviso",JOptionPane.INFORMATION_MESSAGE);
                int id_investidor = res.getInt("id_investidor");
                String CPF = res.getString("cpf");
                String Senha = res.getString("senha");
                ...
                Usuario usuario1 = new Usuario(CPF, Senha, Nome, Saldo, Bitcoin, Ethereum, Ripple);
                dao.comprarEthereum(usuario1);
                
                Connection conn1 = conexao.getConnection();
                UsuarioDAO dao1 = new UsuarioDAO(conn1);
                ResultSet res1 = dao1.consultar(usuario1);
                dao1.inserirExtEthe(usuario1, ethereum, preco, cotacao, id_investidor);
                ...
                JOptionPane.showMessageDialog(view, "Ethereum não comprado",
                        "Erro",JOptionPane.ERROR_MESSAGE);
            }
        } catch(SQLException e){
            JOptionPane.showMessageDialog(view, "Erro de conexao",
    ...
    public void comprarRipple(){
        ...
        try{
            ...
            ResultSet res = dao.consultar(usuario);
            if(res.next()){
                JOptionPane.showMessageDialog(view, "Ripple Comprado",
                        "Aviso",JOptionPane.INFORMATION_MESSAGE);
                int id_investidor = res.getInt("id_investidor");
                String CPF = res.getString("cpf");
                String Senha = res.getString("senha");
                ...
                Usuario usuario1 = new Usuario(CPF, Senha, Nome, Saldo, Bitcoin, Ethereum, Ripple);
                dao.comprarRipple(usuario1);
                
                Connection conn1 = conexao.getConnection();
                UsuarioDAO dao1 = new UsuarioDAO(conn1);
                ResultSet res1 = dao1.consultar(usuario1);
                dao1.inserirExtRip(usuario1, ripple, preco, cotacao, id_investidor);
                ...
                JOptionPane.showMessageDialog(view, "Ripple não comprado",
                        "Erro",JOptionPane.ERROR_MESSAGE);
            }
        } catch(SQLException e){
            JOptionPane.showMessageDialog(view, "Erro de conexao",
